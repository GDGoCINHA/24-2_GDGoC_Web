...
export default function Recruit3( {step} ) {
  ...
  const [nationalityContent, setNationalityContent] = useState("");
    ...
    <div 
      ...
      >
        <Checkbox 
          ...
          classNames={{
            wrapper: "hidden",
            label: `text-white text-xl w-[150px] h-[67px] flex justify-center items-center rounded-md ${nationality.includes("대한민국") ? "bg-[#471915] border-[1.5px] border-[#ea4335]" : "bg-[#181818]"}`
          }}
        >대한민국</Checkbox>
        <Checkbox 
          value="기타"
          ...
          classNames={{
            wrapper: "hidden",
            label: `text-white text-xl w-[150px] h-[67px] flex justify-center items-center rounded-md ${nationality.includes("기타") ? "bg-[#471915] border-[1.5px] border-[#ea4335]" : "bg-[#181818]"}`
          }}
        >기타</Checkbox>
      </CheckboxGroup>

      {nationality.includes("기타") && (
        <Input
          variant="bordered"
          placeholder="국가를 입력해주세요"
          className="max-w-xs mt-4"
          value={nationalityContent}
          onValueChange={setNationalityContent}
          classNames={{
            mainWrapper: "w-60 h-[57px]",
            label: "!text-white text-xl pb-[18px]",
            inputWrapper: `h-[57px] border-[#bbbbbb30] border-[1.5px] rounded-md text-white text-xl
