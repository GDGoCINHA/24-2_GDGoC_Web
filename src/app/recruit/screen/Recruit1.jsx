    ...
    >
      ...
      <div className='flex flex-col w-full bg-[#95959514] h-[358px] mt-[47px] p-2 rounded-2xl border-1 border-[#ffffff34] overflow-y-scroll mobile:mt-[27px] mobile:p-4'>
        ...
        <p className='text-[#C5C5C5] text-base font-normal'>
          ...
          보호법(법률 제19234호)」에 따라 아래와 같이 개인정보를 <br/>수집·이용 및 제3자 제공하고자 합니다. 내용을 자세히
          읽은 후 동의 여부를 결정하여 주십시오.
        </p>
        <br />
        <p className='text-white text-xl font-semibold'>✅ 개인정보 수집·이용 및 제3자 제공 항목</p>
        <p className='text-[#C5C5C5] text-base font-normal'>
          인하대학교 등록 및 졸업·수료·휴학 여부, 성명, 소속 대학(원) 및 전공, 학년, 학번, 전화번호, 이메일, 성별,
          출생일, 국적, 기타 이 동아리 지원서에 지원자가 제공한 정보
        </p>
        <br />
        <p className='text-white text-xl font-semibold'>✅ 개인정보 수집·이용 및 제3자 제공 목적</p>
        <p className='text-[#C5C5C5] text-base font-normal'>1. 이 동아리의 운영 및 관리</p>
        <p className='text-[#C5C5C5] text-base font-normal'>2. 이 동아리가 참여하는 행사 및 프로그램 운영 및 관리</p>
        <br />
        <p className='text-white text-xl font-semibold'>✅ 개인정보 제공받는 자 (제3자)</p>
        <p className='text-[#C5C5C5] text-base font-normal'>구글코리아(유), 정석인하학원(학), 인하대학교 동아리연합회</p>
        <br />
        <p className='text-white text-xl font-semibold'>✅ 개인정보 보유·이용 및 제3자 제공 기간</p>
        <p className='text-[#C5C5C5] text-base font-normal'>
          지원서 제출일로부터 1년까지 귀하의 개인정보를 보유 및 이용 그리고 제3자 제공하며, 이후 개인정보는 폐기
          처리됩니다.
        </p>
        <br />
        <p className='text-white text-xl font-semibold'>✅ 동의 거부 권리 및 불이익</p>
        <p className='text-[#C5C5C5] text-base font-normal'>
