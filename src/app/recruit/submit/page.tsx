        ...
        <div className='text-xl mt-[20px] mobile:text-sm items-center justify-center mobile:text-center'>
          ...
          <div className='flex mobile:flex-col justify-center'>
            <div>회비 납부 확인 후,
              ...
              <strong className='text-red'>C</strong> <strong>INHA </strong>
            </div>
            <div className='mobile:'>채팅방에 초대해 드리겠습니다.</div>
          </div>
        </div>
      <Button variant='solid' color="success" className="mt-[50px] p-5 rounded-full text-white text-[15px] font-semibold !bg-green mb-[50px]" onPress={() => router.push('/')}>메인으로 이동하기</Button>
    </div>
  );
}
