    ...
    <>
        <div className="flex flex-col max-w-[1305px] mx-auto h-full pt-[132px]">
                ...
                <div className="flex flex-row flex-none h-full">
                  ...
                  <div className="flex flex-col relative pr-[46px]">
                    <div id="line" className="absolute flex items-center justify-center h-full w-full">
                      ...
                      <div id="long-line-red" className={`absolute top-0 bg-red-500 w-1 transition-all duration-500 ease-in-out`} style={{height: `${step === 1 ? 0 : step <= 4 ? 20 : step === 5 ? 40 : step <= 7 ? 60 : step <= 10 ? 80 : 100}%`}}></div>
                    </div>
                    <div id="circle" className="absolute flex flex-col items-center justify-between h-full w-full">
                      ...
                      <div id="circle-5" className={`w-8 h-8 rounded-full flex items-center justify-center text-white text-2xl transition-all duration-500 ease-in-out ${step >= 8 ? "bg-red-500" : "bg-gray-500"}`}>✓</div>
                      <div id="circle-6" className={`w-8 h-8 rounded-full flex items-center justify-center text-white text-2xl transition-all duration-500 ease-in-out ${step >= 11 ? "bg-red-500" : "bg-gray-500"}`}>✓</div>
                    </div>
            ...
            <div className="flex w-full items-center justify-end mt-[72px]">
              <Button className="bg-red-500 text-white rounded-full w-[183px] h-[57px] text-lg font-semibold" onPress={step < 11 ? () => setStep(step + 1) : () => { alert("완료") }}>
                {step < 11 ? "다음" : "완료"}
              </Button>
            </div>
        </div>
