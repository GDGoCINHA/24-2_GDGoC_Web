            ...
            <div className="max-w-6xl mx-auto flex flex-col gap-8">
                <header className="flex flex-col gap-4 md:flex-row md:items-end md:justify-between bg-white/70 rounded-3xl border border-slate-200 p-6 shadow-lg shadow-slate-100">
                    <div>
                        ...
                        <h1 className="text-3xl font-semibold mt-1 text-slate-900">GDGoC Homecoming 럭키드로우</h1>
                    ...
                    <div className="flex flex-wrap items-center gap-3">
                        <a
                            ...
                            className="rounded-full border border-slate-200 px-5 py-2 text-sm text-slate-700 hover:border-cblue/60 hover:text-cblue"
                        >
                            방명록 관리로 이동
                        </a>
                        <button
                ...
                <section className="grid gap-6 md:grid-cols-[1.2fr,0.8fr]">
                    <div className="bg-white border border-slate-200 rounded-3xl p-6 shadow-lg shadow-slate-100">
                        ...
                        <form className="flex flex-col gap-5" onSubmit={handleDraw}>
                            ...
                            <p className="text-sm text-cgreen min-h-[20px]">{statusMessage}</p>
                    ...
                    <div className="bg-white border border-slate-200 rounded-3xl p-6 shadow-lg shadow-slate-100">
                        ...
                        <div className="space-y-4">
                            <div>
                                ...
                                <p className="text-2xl font-semibold text-slate-900">{entriesCount.toLocaleString()}명</p>
                            </div>
                            <div>
                                <p className="text-sm text-slate-500">당첨자 수</p>
                                <p className="text-2xl font-semibold text-slate-900">{recentCount.toLocaleString()}명</p>
                            </div>
                                ...
                                <div
                                    ...
                                    className={`rounded-2xl border px-5 py-4 transition-shadow ${
                                        recentWinnerIds.includes(winner.id)
                                            ? 'border-cyellow shadow-[0_0_18px_rgba(251,188,5,0.35)]'
                                            : 'border-slate-200'
                                    }`}
                                >
