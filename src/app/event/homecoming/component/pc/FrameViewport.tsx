...
const FrameViewport = forwardRef<HTMLDivElement, FrameViewportProps>(function FrameViewport(
  { onScroll },
  ref
) {
  return (
    <div
      ...
      className="
        relative
        h-full w-full
        overflow-y-auto no-scrollbar snap-y snap-mandatory font-pretendard text-white
      "
    >
      <FrameSection>
        <FirstSection />
  ...
  return (
    <div className="flex flex-col justify-center text-white">
      ...
      <p className="mt-20 px-24 text-2xl leading-relaxed">
        ...
        <br />
        이후 <strong>오프닝 특강</strong>과 <strong>연간 활동 소개</strong>,{' '}
        <strong>OB 및 초청자 인사</strong>를 거쳐
        <br />
...
function SecondSection() {
  return (
    <div className="flex flex-col text-white">
      ...
      <div className="mt-16 grid grid-cols-2 text-large gap-12 px-24">
        ...
        <div>
          <TimeRow
            time="13:00–13:20"
            title="참가자 입장 및 체크인"
            desc="오프닝 안내 · 활동 소개 영상 상영"
          />
          <TimeRow
            time="13:20–13:30"
            title="1부 라운드 운영 방식 안내"
            desc="팀별 데모 시연 및 발표 준비"
          />

          <TimeRow
            time="13:30–15:10"
            title="프로젝트 성과 발표 및 데모 시연"
            desc="총 6라운드 · 상호 피드백 · QnA"
          />
      ...
      <div className="mt-14 px-24 text-white/80 text-lg leading-snug">
        • 1부 참석자: <span className="font-semibold text-white">12:50</span>까지 도착
        <br />• 2부 참석자: <span className="font-semibold text-white">15:50</span>까지 도착
      </div>
    </div>
  )
}
...
function ThirdSection() {
  return (
    <div className="flex flex-col text-white">
      ...
      <div className="mt-6 text-2xl self-center text-white/80">13:00–15:30</div>
...
function FourthSection() {
  return (
    <div className="flex flex-col text-white">
      ...
      <div className="mt-6 text-2xl self-center text-white/80">15:30–19:00</div>
...
function FifthSection() {
  return (
    <div className="flex flex-col text-white">
      ...
      <div className="mt-6 text-2xl self-center text-white/80">
        (인천광역시 연수구 컨벤시아대로 204 인스타2)
      </div>

      <HomecomingMap />

      <div className="mt-14 px-24 text-white/80 text-lg text-center">
        문의사항이 있으실 경우, <span className="font-semibold text-white">010-2087-1816</span>으로
        편하게 연락 부탁드립니다.
      </div>
    </div>
  )
...
function TimeRow({ time, title, desc }: TimeRowProps) {
  return (
    <div className="flex gap-6 py-2 font-xl">
      <div className="w-[140px] shrink-0 font-bold text-white">{time}</div>
      <div className="flex-1">
        <div className="font-semibold text-white">{title}</div>
        {desc ? <div className="text-white/70 leading-snug">{desc}</div> : null}
      </div>
    </div>
  )
}
...
function HomecomingMap() {
  ...
  return (
    <div className="mt-16 rounded-2xl w-[1000px] h-[400px] overflow-hidden self-center">
      <GoogleMap
