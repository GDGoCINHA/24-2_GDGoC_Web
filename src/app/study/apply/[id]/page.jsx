...
export default function Apply() {
    ...
    return (
        <>
            ...
            <Header/>
            <header
                className="relative flex flex-col select-none pt-[35px] px-[96px] mobile:px-[24px] items-center justify-center text-center">
            ...
            <div className="relative flex flex-col items-center justify-center w-full px-[96px] mobile:px-[24px] py-8">
                <div
                    className="w-full max-w-[800px] border border-white rounded-lg p-7 mobile:pb-2 relative overflow-hidden">
                    <div className="text-white relative">
                        {studyDetail ? (
                            <>
                                ...
                                <form onSubmit={handleSubmit} className="space-y-6">
                                    <label className="block">
                                        <p className="text-lg font-semibold text-white">자기소개 <span
                                    ...
                                    <label className="block">
                                        <p className="text-lg font-semibold text-white">활동 가능한 시간대 <span
                                            className="text-red-500">*</span></p>
                            ...
                            <div
                                className="w-full max-w-[800px] border border-white rounded-lg p-8 relative overflow-hidden">
