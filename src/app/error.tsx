    ...
    <div className="flex flex-col items-center justify-center min-h-screen bg-gradient-to-b from-gray-900 to-black relative overflow-hidden">
      ...
      <div className="z-10 bg-gray-800/70 backdrop-blur-sm p-4 sm:p-8 rounded-xl shadow-2xl border border-red-500/20 max-w-[90%] sm:max-w-md w-full mx-4">
        <div className="flex flex-col items-center justify-center text-center">
          {/* 오류 아이콘 */}
          <div
            className="w-16 h-16 sm:w-20 sm:h-20 rounded-full bg-red-500/10 flex items-center justify-center mb-4 sm:mb-6"
            role="img"
          ...
          <h1 className="text-3xl sm:text-4xl font-bold text-white mb-2">
            ...
            <span className="block text-white text-base sm:text-lg md:text-xl lg:text-2xl">
              {errorTitle}
            </span>
          </h1>
          <div
            className="w-12 sm:w-16 h-1 bg-gradient-to-r from-red-500 to-red-400 rounded-full mb-3 sm:mb-4"
            aria-hidden="true"
          ></div>
          ...
          {process.env.NODE_ENV === 'development' && (
            <div className="mt-2 p-3 sm:p-4 bg-red-500/5 rounded-lg border border-red-500/20 max-w-[90%] sm:max-w-md w-full overflow-auto">
              <p className="text-yellow-400 text-xs sm:text-sm font-mono break-words">
                {errorMessage}
              </p>
            </div>
          )}
