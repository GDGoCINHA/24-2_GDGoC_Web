    ...
    <div className="flex flex-col w-screen">
        ...
        <div className="flex flex-col w-full h-full items-center">
          ...
          <svg className="min-w-[90px] hidden" width="51" height="31" viewBox="0 0 51 31" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <Button 
              ...
              radius="full" className="w-64 mr-3 h-20 mobile:w-40 mobile:h-16 mobile:text-2xl bg-gradient-to-r from-[#EA4335] to-[#FF6E62] text-white text-3xl relative group">
      ...
      <div id="section2" className="flex flex-col w-full h-screen bg-black relative">
        <div className="flex flex-col items-center w-full h-full">
          <div className="text-white text-[3.5vw] mt-40 mobile:text-3xl mobile:mt-24">
          ...
          <div className="text-white space-y-4 font-semibold text-[2.5vw] mobile:text-2xl flex flex-col items-center mobile:items-start mt-20 gap-y-4">
      ...
      <div id="section3" className="flex flex-wrap justify-center items-start h-full w-full mt-[200vh] px-16 gap-x-20 gap-y-16 mobile:flex-col mobile:items-center">
      ...
      <div id="section4" className="flex flex-col h-full w-full justify-center">
        <p className="text-white text-[3.5vw] mobile:text-2xl font-semibold mt-96 text-center">합류하면 어떤 활동들을 할 수 있나요?</p>
      ...
      <div id="section6" className="flex flex-col h-full w-full justify-start items-center">
        <div id="logos" className='w-full'>
          ...
          <div className="flex flex-row w-full items-center mt-32 px-20 justify-between mobile:px-5">
            <div className="flex flex-col items-center justify-center">
              <NextImage src={gdg} alt="gdg" width={200} height={200} className="h-[20vh] mobile:h-[10vh] object-contain" />
              <p className="text-white text-[2.5vw] mobile:text-[3vw] font-semibold mt-4">GDG Korea</p>
            </div>
            <div className="flex flex-col items-center justify-center">
              <NextImage src={gpters} alt="gpters" width={200} height={200} className="h-[20vh] mobile:h-[10vh] object-contain" />
              <p className="text-white text-[2.5vw] mobile:text-[3vw] font-semibold mt-4">GPTERS</p>
            </div>
            <div className="flex flex-col items-center justify-center">
              <NextImage src={kang} alt="kang" width={200} height={200} className="h-[20vh] mobile:h-[10vh] object-contain" />
              <p className="text-white text-[2.5vw] mobile:text-[3vw] font-semibold mt-4">강쌤과외</p>
            </div>
            
          </div>
          <div className="flex flex-row w-full items-center mt-20  mb-32 justify-between px-20 mobile:px-5">
            <div className="flex flex-col items-center justify-center">
              <NextImage src={inha} alt="inha" width={200} height={200} className="h-[20vh] mobile:h-[10vh] object-contain" />
              <p className="text-white text-[2.5vw] mobile:text-[3vw] font-semibold mt-4">SW중심대학<br className="hidden mobile:inline"/>사업단</p>
            </div>
            
            <div className="flex flex-col items-center justify-center">
              <NextImage src={dongyeon} alt="dongyeon" width={200} height={200} className="h-[20vh] mobile:h-[10vh] object-contain" />
              <p className="text-white text-[2.5vw] mobile:text-[3vw] font-semibold mt-4">인하대학교 <br className="hidden mobile:inline"/>동아리연합회</p>
            </div>
            <div className="flex flex-col items-center justify-center">
              <NextImage src={chajidan} alt="chajidan" width={200} height={200} className="h-[20vh] mobile:h-[10vh] object-contain" />
              <p className="text-white text-[2.5vw] mobile:text-[3vw] font-semibold mt-4">인하대학교 <br className="hidden mobile:inline"/>창업지원단</p>
            </div>
          </div>
        </div>
      </div>
      <div id="section7" className="flex flex-col h-full w-full justify-start items-center">
        <p className="text-white text-[3.5vw] mobile:text-2xl font-semibold mt-56 mobile:mt-36">GDGoC와 함께<br className="hidden mobile:inline"/> 변화하는 나를 만나보세요</p>
