        ...
        <div className="splide__track">
            ...
            {slides.map((slide, index) => (
                ...
                <div className="h-[616px] flex items-center justify-center rounded-lg relative overflow-hidden">
                    ...
                    <Image className='w-full h-full object-cover blur-lg opacity-50' width={100} height={100} src={slide.background} alt='event background' />
                    </div>
                    <div className="z-10 flex flex-row w-full h-full">
                    <div className={slide.poster === 'none' ? 'hidden' : 'flex justify-center items-center w-1/2 mobile:hidden '}>
                        <Image src={slide.poster} width={20} height={27} alt='event poster' className='w-[30vw] h-[56vh] object-contain' />
                    </div>
                    <div className={`${slide.poster === 'none' ? 'w-full' : 'w-1/2'} flex justify-center items-start flex-col pr-10 mobile:pl-10 mobile:w-full px-10`}>
