...
export default function Recruit5( {step} ) {
  ...
  const [subMajor2, setSubMajor2] = useState("");
  return (
    <div 
      className={`absolute flex flex-col w-full h-full transition-all duration-500 ease-in-out 
        ...
        <Autocomplete label="주전공" labelPlacement="outside" placeholder="학과를 지정해주세요"
      ...
      <Autocomplete label="다중전공1" labelPlacement="outside" placeholder="학과를 지정해주세요"
          className="!mt-14 w-60"
          classNames={{
              popoverContent: "bg-[#1c1c1c]"
          }}
          ...
          selectedKeys={subMajor}
          onSelectionChange={setSubMajor}
      >
          <AutocompleteSection title="프런티어 학부대학">
              <AutocompleteItem key="자유전공학부" aria-label="자유전공학부" value="자유전공학부">자유전공학부</AutocompleteItem>
          </AutocompleteSection>
      ...
      {subMajor && (
        <Autocomplete label="다중전공2" labelPlacement="outside" placeholder="학과를 지정해주세요"
          className="!mt-14 w-60"
          classNames={{
              popoverContent: "bg-[#1c1c1c]"
          }}
          ...
          selectedKeys={subMajor2}
          onSelectionChange={setSubMajor2}
      >
          <AutocompleteSection title="프런티어 학부대학">
              <AutocompleteItem key="자유전공학부" aria-label="자유전공학부" value="자유전공학부">자유전공학부</AutocompleteItem>
          </AutocompleteSection>
