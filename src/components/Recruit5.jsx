    ...
    <div 
      className={`absolute flex flex-col w-full h-full transition-all duration-500 ease-in-out 
        ...
        <div className="flex flex-col w-full mt-6">
            <p className="text-white text-xl">다중전공</p>
            <p className="text-white text-md mt-2">• 현재 진행 중인 다중 전공(복수전공, 부전공, 융합전공, 연계전공)을 순서에 맞게 띄어쓰기 없이 정확한 이름으로 입력해주세요.<br/> ex) XXX 학과 복수전공, 000학과 융합전공</p>
            <Input 
                value={subMajor}
                onValueChange={setSubMajor}
                variant="bordered"
