    ...
    <div id="section1" className="flex flex-col h-screen w-full relative">
      ...
      <div className="flex flex-col w-full h-full items-center">
        ...
        <div ref={subTitleRef} className="flex flex-col items-center opacity-0">
          <div className="font-google-sans-flex text-4xl mt-4 flex mobile:text-5xl mobile:mt-8">
            <span className="text-red neon-text tracking-normal">G</span>
            <span className="text-green neon-text tracking-normal">D</span>
            <span className="text-yellow neon-text tracking-normal">G</span>
            <span className="text-blue neon-text tracking-normal">o</span>
            <span className="text-red neon-text tracking-normal">C</span>
