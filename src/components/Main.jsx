...
export default function Main() {
  ...
  useEffect(() => {
    ...
    tl.to(neonLetters, {
      ...
      yoyo: true,
      repeat: 3,
      ease: "steps(1)", // 계단식 애니메이션으로 지직거리는 효과 구현
      stagger: {
    ...
    <div className="flex flex-col w-screen">
      <div id="section1" className="flex flex-col h-screen w-full relative">
        ...
        <div className="flex flex-col w-full h-full items-center">
          <div id="typing-effect" className="text-white text-[3.5vw] mobile:text-xl font-bold min-h-[48px] mobile:min-h-[30px] mt-60 mobile:mt-40 mobile:text-center mobile:max-w-[350px]">
          </div>
          <div className="font-ocra text-4xl mt-4 flex opacity-0" ref={logoRef}>
          ...
          <p className="text-white mt-32 mobile:mt-48 text-[35px] mobile:text-2xl font-semibold opacity-0" ref={recruitTextRef}>2025-1 Recruit</p>
          <div className="flex flex-row mt-[41px] w-full justify-center items-center opacity-0" ref={buttonRef}>
          <svg className="min-w-[90px] hidden" width="51" height="31" viewBox="0 0 51 31" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path 
              ref={leftArrowRef}
            ...
            <Button radius="full" className="w-64 mr-3 h-20 mobile:w-40 mobile:h-16 mobile:text-2xl bg-gradient-to-r from-[#EA4335] to-[#FF6E62] text-white text-3xl relative group">
            ...
            <svg width="90" className="hidden" height="68" viewBox="0 0 90 68" fill="none" xmlns="http://www.w3.org/2000/svg">
              <path 
                ref={rightArrowRef}
      ...
      <div id="section2" className="flex flex-col w-full h-screen bg-black relative">
        <div className="flex flex-col items-center w-full h-full">
          <div className="text-white text-6xl mt-40 mobile:text-3xl mobile:mt-24">
            <span className="font-ocra">
          ...
          <div className="text-white space-y-4 font-semibold text-4xl mobile:text-2xl flex flex-col items-center mobile:items-start mt-28 gap-y-4">
            <p id="section2-text1" className="opacity-0" ><span className="text-red-500">개발</span>에 관심 있는 사람들이 모여 <br className="hidden mobile:inline" /><span className="text-green-500">네트워킹</span> 하고,</p>
            <p id="section2-text2" className="opacity-0">다양한 프로젝트에 참여하며 <br className="hidden mobile:inline" /><span className="text-yellow-500">함께 성장</span>하는 공간입니다.</p>
            <p id="section2-text3" className="opacity-0">비개발자부터 숙련된 개발자까지 <br className="hidden mobile:inline" />누구나 <span className="text-blue-500">함께</span>할 수 있습니다.</p>
            <p id="section2-text4" className="opacity-0">GDGoC라는 글로벌 IT 무대에서 <br className="hidden mobile:inline" />끊임없이 기회를 찾고 <span className="text-red-500">성장</span>해보세요!</p>
            
          </div>
        </div>
      </div>
      <div id="section3" className="flex flex-row mobile:flex-col justify-between items-start h-full w-full mt-[200vh] px-20 tablet:px-5 mobile:px-0 mobile:items-center mobile:gap-y-16">
        <div className="flex flex-col items-center justify-center">
          <p className="text-red-500 text-4xl tablet:text-3xl font-semibold mb-4">전세계</p>
          <div className="flex flex-row">
            <p className="text-white text-8xl tablet:text-7xl number-animation text-right min-w-[220px] tablet:min-w-[170px]">1863</p>
            <p className="text-white text-8xl tablet:text-7xl">+</p>
          </div>
        </div>
        <div className="flex flex-col items-center justify-center">
          <p className="text-green-500 text-4xl tablet:text-3xl font-semibold mb-4">참여국가</p>
          <div className="flex flex-row">
            <p className="text-white text-8xl tablet:text-7xl number-animation text-right min-w-[160px] tablet:min-w-[110px] mobile:min-w-[130px]">111</p>
            <p className="text-white text-8xl tablet:text-7xl">개국</p>
          </div>
        </div>
        <div className="flex flex-col items-center justify-center">
          <p className="text-yellow-500 text-4xl tablet:text-3xl font-semibold mb-4">국내</p>
          <div className="flex flex-row">
            <p className="text-white text-8xl tablet:text-7xl number-animation text-right min-w-[130px] tablet:min-w-[80px]">36</p>
            <p className="text-white text-8xl tablet:text-7xl">대학</p>
          </div>
        </div>
        <div className="flex flex-col items-center justify-center">
          <p className="text-blue-500 text-4xl tablet:text-3xl font-semibold mb-4">현재 멤버</p>
          <div className="flex flex-row">
            <p className="text-white text-8xl tablet:text-7xl number-animation text-right min-w-[160px] tablet:min-w-[90px]">102</p>
            <p className="text-white text-8xl tablet:text-7xl">명</p>
          </div>
        </div>
      </div>
      <div id="section4" className="flex flex-col h-full w-full justify-center">
        <p className="text-white text-6xl mobile:text-2xl font-semibold mt-96 text-center">합류하면 어떤 활동들을 할 수 있나요?</p>
        <div id="cards" className="flex flex-col w-full h-full mt-36 mb-36 opacity-0">
          <div className="grid grid-cols-3 mobile:grid-cols-2 gap-5 px-28 tablet:px-12 mobile:px-4">
              <div id="card" className="group relative w-full h-[300px] rounded-2xl overflow-hidden">
                <Image 
                  isBlurred 
                  src={card1.src} 
                  alt="card1" 
                ...
                <div className="absolute inset-0 bg-black/70 opacity-0 group-hover:opacity-100 transition-opacity duration-300 flex items-center justify-center z-10">
                  <div className="text-white text-center p-6">
                    ...
                    <p className="text-lg">실전활용도 높은 온/오프 강연</p>
                  </div>
                </div>
              </div>
              <div id="card" className="group relative w-full h-[300px] rounded-2xl overflow-hidden">
                ...
                <div className="absolute inset-0 bg-black/70 opacity-0 group-hover:opacity-100 transition-opacity duration-300 flex items-center justify-center z-10">
                  <div className="text-white text-center p-6">
                    ...
                    <p className="text-lg">정성 가득 시험기간 간식드리미</p>
                  </div>
                </div>
              </div>
              <div id="card" className="group relative w-full h-[300px] rounded-2xl overflow-hidden">
                ...
                <div className="absolute inset-0 bg-black/70 opacity-0 group-hover:opacity-100 transition-opacity duration-300 flex items-center justify-center z-10">
                  <div className="text-white text-center p-6">
                    <h3 className="text-2xl font-bold mb-2">네트워킹 행사</h3>
                    <p className="text-lg">MT/한강/잔막 등 다같이 외부 나들이</p>
                  </div>
                </div>
              </div>
              <div id="card" className="group relative w-full h-[300px] rounded-2xl overflow-hidden">
                ...
                <div className="absolute inset-0 bg-black/70 opacity-0 group-hover:opacity-100 transition-opacity duration-300 flex items-center justify-center z-10">
                  <div className="text-white text-center p-6">
                    <h3 className="text-2xl font-bold mb-2">내부 행사</h3>
                    <p className="text-lg">자체•연합 해커톤 주최 및 참여</p>
                  </div>
                </div>
              </div>
              <div id="card" className="group relative w-full h-[300px] rounded-2xl overflow-hidden">
                ...
                <div className="absolute inset-0 bg-black/70 opacity-0 group-hover:opacity-100 transition-opacity duration-300 flex items-center justify-center z-10">
                  <div className="text-white text-center p-6">
                    <h3 className="text-2xl font-bold mb-2">외부행사</h3>
                    <p className="text-lg">Google 등 IT기업의 네트워킹/레퍼런스 참여</p>
                  </div>
                </div>
              </div>
              <div id="card" className="group relative w-full h-[300px] rounded-2xl overflow-hidden">
      ...
      <div id="section6" className="flex flex-col h-full w-full justify-start items-center">
        <div id="logos">
          <div className="text-white text-6xl mobile:text-3xl mt-60 mobile:mt-24 w-full text-center">
            <span className="font-ocra">
          ...
          <div className="flex flex-row w-full justify-center items-center mt-40 gap-x-32 tablet:gap-x-8 mobile:gap-x-2">
            <div className="flex flex-col items-center justify-center">
              <NextImage src={gdg} alt="gdg" width={200} height={200} className="h-[200px] tablet:h-[150px] mobile:h-[80px] object-contain" />
              <p className="text-white text-2xl mobile:text-base font-semibold mt-4">GDG Korea</p>
            </div>
            <div className="flex flex-col items-center justify-center">
              <NextImage src={gpters} alt="gpters" width={200} height={200} className="h-[200px] tablet:h-[150px] mobile:h-[80px] object-contain" />
              <p className="text-white text-2xl mobile:text-base font-semibold mt-4">GPTERS</p>
            </div>
            <div className="flex flex-col items-center justify-center">
              <NextImage src={kang} alt="kang" width={200} height={200} className="h-[200px] tablet:h-[150px] mobile:h-[80px] object-contain" />
              <p className="text-white text-2xl mobile:text-base font-semibold mt-4">강쌤과외</p>
            </div>
            
          </div>
          <div className="flex flex-row w-full justify-center items-center mt-20 gap-x-32 mb-32 tablet:gap-x-8 mobile:gap-x-2">
            {/* <div className="flex flex-col items-center justify-center">
              <NextImage src={link} alt="link" width={200} height={200} className="h-[200px] tablet:h-[150px] mobile:h-[80px] object-contain" />
              <p className="text-white text-2xl mobile:text-base font-semibold mt-4">LINK3.0 <br className="hidden mobile:inline"/> 사업단</p>
            </div> */}
            <div className="flex flex-col items-center justify-center">
              <NextImage src={inha} alt="inha" width={200} height={200} className="h-[200px] tablet:h-[150px] mobile:h-[80px] object-contain" />
              <p className="text-white text-2xl mobile:text-base font-semibold mt-4">SW중심대학<br className="hidden mobile:inline"/>사업단</p>
            </div>
            
            <div className="flex flex-col items-center justify-center">
              <NextImage src={dongyeon} alt="dongyeon" width={200} height={200} className="h-[200px] tablet:h-[150px] mobile:h-[80px] object-contain" />
              <p className="text-white text-2xl mobile:text-base font-semibold mt-4">인하대학교 <br className="hidden mobile:inline"/>동아리연합회</p>
            </div>
            <div className="flex flex-col items-center justify-center">
              <NextImage src={chajidan} alt="chajidan" width={200} height={200} className="h-[200px] tablet:h-[150px] mobile:h-[80px] object-contain" />
              <p className="text-white text-2xl mobile:text-base font-semibold mt-4">인하대학교 <br className="hidden mobile:inline"/>창업지원단</p>
            </div>
          </div>
        </div>
      </div>
      <div id="section7" className="flex flex-col h-full w-full justify-start items-center">
        <p className="text-white text-6xl mobile:text-3xl font-semibold mt-56 mobile:mt-36">GDGoC와 함께<br className="hidden mobile:inline"/> 변화된 나를 마주하세요</p>
        <div className="flex flex-row mt-32 mb-96 mobile:mb-60 w-full justify-center items-center">
          <svg className="min-w-[90px] hidden" width="51" height="31" viewBox="0 0 51 31" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path 
              d="M2.21611 2.34863C7.10778 14.0088 23.2195 33.429 48.534 17.8271M48.534 17.8271L36.0617 12.2884M48.534 17.8271L44.3587 29.278" 
              stroke="#BFBFBF" 
